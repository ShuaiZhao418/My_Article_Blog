...
const AddCommentForm = ({ comments }) => {
    ...
    return (
        <form className = "shadow rounded px-8 pt-6 pb-8 mb-4">
            ...
            <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3
            ...
            rounded focus:outline-none focus:shadow-outline' onClick={() => addComment()}>
                Add Comment
            </button>
        </form>
    )
